...
@click.option("--image", required=True, help="Docker image URL for the updated application")
@click.option("--container-name", required=True, help="Name of the container to update")
@click.option("--collectstatic-task", default="django-collectstatic-task", help="Name of the collectstatic task definition")
